...
<form class="max-w-sm mx-auto" action="{{route('posts.store')}}" method="POST">
    ...
    <div class="mb-5">
        ...
        <input type="titulo" value="{{old('titulo')}}" id="titulo" name="titulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
        @error('titulo')
            <x-error>
                {{$message}}
            </x-error>
    ...
    <div class="mb-2">
        <input id="publicado" type="radio" name="categoria" @checked(@old("categoria") == "Publicado") value="Publicado"  class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="publicado" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 mr-4">Publicado</label>
        <input id="borrador" type="radio" name="categoria" @checked(@old("categoria") == "Borrador") value="Borrador" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
