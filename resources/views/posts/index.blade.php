...
<div class="relative overflow-x-auto">
    <div class="flex flex-row-reverse mb-2">
        <a href="{{route('posts.create')}}" class="px-2 py-1 rounded-xl text-white font-bold bg-blue-500 hover:bg-blue-700">
            <i class="fas fa-add text-xl mr-2"></i> Nuevo
        </a>
    </div>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <form method="POST" action="{{route('posts.destroy', $item)}}">
                        @csrf
                        @method('DELETE')
                        <a href="{{route('posts.edit', $item)}}"><i class="fas fa-edit text-green-400 hover:text-xl"></i></a>
                        <button type="submit">
                            <i class="fas fa-trash text-red-400 hover:text-xl"></i>
                        </button>
                    </form>
                </td>
            </tr>
